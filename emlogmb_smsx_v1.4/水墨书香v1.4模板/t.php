...
<?php
$head_img = array();
$urlpath = parse_url(TEMPLATE_URL);
$head_root = $_SERVER['DOCUMENT_ROOT'];
foreach(glob($head_root.$urlpath['path']."images/wytx/*.*") as $filename){
$head_img[] = TEMPLATE_URL."images/wytx/".basename($filename);
}
$rand = mt_rand(0,count($head_img)-1);
echo "<img src='".$head_img[$rand]."'>";
?>
   </div>
    <div class="post1"><span><?php echo $author; ?></span><br><?php echo $val['t'].'<br><br>'.$img;?></div>
    <div class="clear"></div>
    <div class="bttome">
