...
const add_id = "u19tmbpwkmcvmgnc"; // app_id
...
function getWeather() {
    fetch("https://www.mxnzp.com/api/ip/self?app_id=" + add_id + "&app_secret=" + app_secret,{
        mode: "cors",
        headers: {
            "Access-Control-Allow-Origin": "https://winkjie.gitee.io"
        }
    })
        .then(response => response.json())
        .then(data => {
...
$("#qq").mouseover(function () {
    $("#link-text").html("QQ:295213085");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#email").mouseover(function () {
    $("#link-text").html("来封 Email:295213085@qq.com");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
...
主页:  https://winkjie.gitee.io/winkjie/WinkJie/
`
